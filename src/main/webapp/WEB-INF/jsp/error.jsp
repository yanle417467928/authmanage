...
<head>
    ...
    <style>
        ...
        .page404 .cont404{width:745px; height:380px; background:url(/static/img/404.gif) left top no-repeat; position:absolute; left:50%; top:50%; margin-left:-372px; margin-top:-190px;}
...
<body>
<div class="page404">
    <div class="cont404"> <a href="http://www.baidu.com" class="return_home">返回首页</a> </div>
</div>
</body>
</html>
