...
public class LoginController extends BaseController {
    ...
    public Object loginPost(HttpServletRequest request, String username, String password, String captcha, @RequestParam(value = "rememberMe",defaultValue = "1")Integer rememberMe){
        ...
        try {
            ...
            throw new RuntimeException("密码不正确！",e);
        }catch (Throwable e){
